...
function showProducts(products) {
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        <p class="text-xl text-red-500 font-semibold mr-1 mt-[60px]">${product.price}</p>
        <button class="bg-[#111928] text-white font-semibold py-2 w-full rounded-md group-hover:bg-red-500 mt-8">Add To Cart</button>
    </div>
    `;
    }
    return result;
